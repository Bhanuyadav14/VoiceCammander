...
class MainActivity : AppCompatActivity() {
    ...
    val permission:Array<String> = arrayOf( Manifest.permission.READ_CONTACTS ,Manifest.permission.WRITE_CONTACTS,Manifest.permission.READ_SMS,Manifest.permission.CALL_PHONE)
...
//                   Aletbox.setTitle("Grant These Permission")
                   ...
                   Aletbox.setNegativeButton("Deny", DialogInterface.OnClickListener(){
                       dialog, which ->

                       Aletbox.show()
                   })
                   Aletbox.setPositiveButton("Allow", DialogInterface.OnClickListener(){
                       dialog, which ->
